...
* [Installing a Linux distribution](#installing-a-linux-distribution)
  * [Needed partitions](#needed-partitions)
  * [Partitioning](#partitioning)
  * [Installation](#installation)
    * [Installing from a live medium](#installing-from-a-live-medium)
    * [Installing from an installation CD](#installing-from-an-installation-cd)
    * [Installing to a virtual machine](#installing-to-a-virtual-machine)
    * [Installing to a real hard drive](#installing-to-a-real-hard-drive)
    * [Selecting the boot device](#selecting-the-boot-device)
      * [So what does the bootloader do?](#so-what-does-the-bootloader-do)
* [Installation of a package](#installation-of-a-package)
  * [Installation with the distribution's package manager](#installation-with-the-distribution's-package-manager)
  * [Installation from source](#installation-from-source)
  * [Installing from different repositories](#installing-from-different-repositories)
  * [Installing proprietary packages](#installing-proprietary-packages)
  * [Other types of installations](#other-types-of-installations)
* [Using the command line](#using-the-command-line)
  * [Environment variables](#environment-variables)
  * [File system](#file-system)
  * [Process utilities](#process-utilities)
  * [Basic network utilities](#basic-network-utilities)
  * [Bash scripting](#bash-scripting)
    * [Redirecting](#redirecting)
      * [tee](#tee)
    * [Piping](#piping)
    * [Processing text in bash - filters](#processing-text-in-bash---filters)
      * [grep](#grep)
    ...
    * [Exploring the filesystem from bash](#exploring-the-filesystem-from-bash)
    * [Process handling commands](#process-handling-commands)
    * [Tweaking/configuring the shell (bash)](#tweakingconfiguring-the-shell-(bash))
    * [Creating scripts for various interpreters](#creating-scripts-for-various-interpreters)
      * [env command](#env-command)
    * [Conditional execution in bash](#conditional-execution-in-bash)
  ...
  * [other shells: sh,csh,ksh,bash,dash,...](#other-shells:-sh,csh,ksh,bash,dash,...)
* [Working remotely](#working-remotely)
  * [From Linux](#from-linux)
  * [From Windows](#from-windows)
  * [From Other operating systems](#from-other-operating-systems)
  * [Running remote graphical applications](#running-remote-graphical-applications)
    * [On Linux](#on-linux)
